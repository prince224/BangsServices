...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/gestion')) {
            ...
            // Page_admin_modifier_section_page
            if (0 === strpos($pathinfo, '/gestion/modifier_section_page') && preg_match('#^/gestion/modifier_section_page/(?P<idsection>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Page_admin_modifier_section_page')), array (  '_controller' => 'Cms\\PageBundle\\Controller\\AdminController::modifier_section_pageAction',));
            }

            if (0 === strpos($pathinfo, '/gestion/supprimer_')) {
                // Page_admin_supprimer_section_page
                if (0 === strpos($pathinfo, '/gestion/supprimer_section_page') && preg_match('#^/gestion/supprimer_section_page/(?P<idsection>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'Page_admin_supprimer_section_page')), array (  '_controller' => 'Cms\\PageBundle\\Controller\\AdminController::supprimer_section_pageAction',));
                }

                // Page_admin_supprimer_categories_section_page
                if (0 === strpos($pathinfo, '/gestion/supprimer_categories_section_page') && preg_match('#^/gestion/supprimer_categories_section_page/(?P<idsection>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'Page_admin_supprimer_categories_section_page')), array (  '_controller' => 'Cms\\PageBundle\\Controller\\AdminController::supprimer_categories_section_pageAction',));
                }

            }

            // Page_admin_voir_sous_menu_page
            if (0 === strpos($pathinfo, '/gestion/voir_sous_menu_page') && preg_match('#^/gestion/voir_sous_menu_page/(?P<idsousmenu>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Page_admin_voir_sous_menu_page')), array (  '_controller' => 'Cms\\PageBundle\\Controller\\AdminController::voir_sous_menu_pageAction',));
            }

            // Page_admin_ajouter_sous_menu_page
            if (0 === strpos($pathinfo, '/gestion/ajouter_sous_menu_page') && preg_match('#^/gestion/ajouter_sous_menu_page/(?P<idpage>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Page_admin_ajouter_sous_menu_page')), array (  '_controller' => 'Cms\\PageBundle\\Controller\\AdminController::ajouter_sous_menu_pageAction',));
            }
