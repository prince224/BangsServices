 ...
 */
class Photo extends \Cms\DomaineBundle\Entity\Photo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'id', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'page', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'contenu', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'sousmenu', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'numero', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'url', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'alt', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'title', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'file', '' . "\0" . 'Cms\\DomaineBundle\\Entity\\Photo' . "\0" . 'tempFilename');
        }
    ...
    public function setSousmenu(\Cms\DomaineBundle\Entity\SousMenu $sousmenu = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSousmenu', array($sousmenu));
    ...
    public function getSousmenu()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSousmenu', array());
