 ...
 */
class Section extends \Cms\PageBundle\Entity\Section implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cms\\PageBundle\\Entity\\Section' . "\0" . 'id', '' . "\0" . 'Cms\\PageBundle\\Entity\\Section' . "\0" . 'nom', '' . "\0" . 'Cms\\PageBundle\\Entity\\Section' . "\0" . 'numero', '' . "\0" . 'Cms\\PageBundle\\Entity\\Section' . "\0" . 'contenus', '' . "\0" . 'Cms\\PageBundle\\Entity\\Section' . "\0" . 'page');
        }
    ...
    public function addContenus(\Cms\ArticleBundle\Entity\Contenu $contenus)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addContenus', array($contenus));
    ...
    public function removeContenus(\Cms\ArticleBundle\Entity\Contenu $contenus)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeContenus', array($contenus));

        return parent::removeContenus($contenus);
    }
    ...
    public function getContenus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContenus', array());
